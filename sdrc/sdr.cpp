...
CScriptContext::CScriptContext(int s) {
	...
	addBuiltInFunction("saturate","c=cf",0);
	...
	addBuiltInFunction("voxel3d","v=Sfpf",0);
	addBuiltInFunction("voxelinfo","f=SfSv",0);
	...
	addGlobalVariable("otime",	SLC_FLOAT | SLC_UNIFORM,	SLC_SURFACE | SLC_DISPLACEMENT | SLC_LIGHT | SLC_VOLUME);
