...
public:
		...
		int				getDicingStats(int depth, int &minDivU,int &minDivV) const { minDivU = minDivV = maxx(3-depth,1); return 0; }
...
public:
		...
		int				getDicingStats(int depth, int &minDivU,int &minDivV) const { minDivU = maxx(3-depth,1); minDivV = 1; return 0; }
...
public:
		...
		int				getDicingStats(int depth, int &minDivU,int &minDivV) const { minDivU = minDivV = maxx(3-depth,1); return 2; }
