...
#define	SEQLEXPR			if(op1[0] == NULL) { res[0] = 0.0; error(CODE_SCRIPT,"Warning : Comparing uninitilized string\n");}\
                            else if (strcmp(op1[0],op2[0]) == 0)	res[0]	=	1.0f;					\
							else							res[0]	=	0;



#define	SNEQLEXPR			if(op1[0] == NULL) {res[0] = 0.0; error(CODE_SCRIPT,"Warning : Comparing uninitilized string\n");} \
                            else if (strcmp(op1[0],op2[0]) != 0)	res[0]	=	1.0f;					\
							else							res[0]	=	0;
