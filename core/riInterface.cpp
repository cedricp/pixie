...
void		CRiInterface::RiAbcArchiveV(const char *name,int n,const char *tokens[],const void *params[]) {
}
...
void		CRiInterface::RiCustomDisplay2V(const char *name, RtToken mode, void* cppDisplayWrap, RtInt n, RtToken tokens[], RtPointer params[]) {
}
...
void		CRiInterface::RiMakeSphericalEnvironmentV(const char *pic,const char *tex,float (*filterfunc)(float,float,float,float),float swidth,float twidth,int n,const char *tokens[],const void *params[]) {
}
...
void		CRiInterface::RiPtFilterV(const char *filterType, const char* filename, const char* outfilename, int n, const char *tokens[], const void* params[]){
