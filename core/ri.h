...
EXTERN(RtToken)	 RI_CATMULLCLARK,RI_HOLE,RI_CREASE,RI_CORNER,RI_INTERPOLATEBOUNDARY,RI_FACEVARYINGINTERPOLATEBOUNDARY;
...
EXTERN(RtVoid)
    ...
    RiMakeSphericalEnvironment (const char *pic, const char *tex, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, ...),
    RiMakeSphericalEnvironmentV (const char *pic, const char *tex, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer params[]),
	...
	RiPtFilterV(const char *filterType, const char* filename, const char* outfilename, int n, RtToken  tokens[], RtPointer params[]);
