...
public:
	...
	void				RiAbcArchiveV(const char *name,int n,const char *tokens[],const void *params[]);
    ...
    void                RiCustomDisplay2V(const char *name, RtToken mode,void* cppDisplayWrap, int n,const char *tokens[],const void *params[]);
	...
	void				RiAbcArchive(const char* name, int n,const char *tokens[],const void *params[]);
	...
	void				RiMakeSphericalEnvironmentV(const char *pic,const char *tex,float (*filterfunc)(float,float,float,float),float swidth,float twidth,int n,const char *tokens[],const void *params[]);
	...
	void        		RiPtFilterV(const char *filterType, const char* filename, const char* outfilename, int n, const char *tokens[], const void* params[]);

    bool                ReadBGeoFile(const char* filename, const char*type, const char* matname);
