...
inline	void	initv3(SCALAR_TYPE *r,const SCALAR_TYPE* x) {
	r[0]	=	x[0];
	r[1]	=	x[1];
	r[2]	=	x[2];
}

inline	void	initv4(SCALAR_TYPE *r,const SCALAR_TYPE x) {
	r[0]	=	x;
	r[1]	=	x;
	r[2]	=	x;
	r[3]	=	x;
...
inline	void	addvv4(SCALAR_TYPE *result,const SCALAR_TYPE *s1) {
	result[0]	+=	s1[0];
	result[1]	+=	s1[1];
	result[2]	+=	s1[2];
	result[3]	+=	s1[3];
...
inline	void	addvv4(SCALAR_TYPE *result,const SCALAR_TYPE *s1,const SCALAR_TYPE *s2) {
	result[0]	=	s1[0] + s2[0];
	result[1]	=	s1[1] + s2[1];
	result[2]	=	s1[2] + s2[2];
	result[3]	=	s1[3] + s2[3];
...
inline	void	subvv4(SCALAR_TYPE *result,const SCALAR_TYPE *s1,const SCALAR_TYPE *s2) {
	result[0]	=	s1[0] - s2[0];
	result[1]	=	s1[1] - s2[1];
	result[2]	=	s1[2] - s2[2];
	result[3]	=	s1[3] - s2[3];
...
inline	void	subvv4(SCALAR_TYPE *result,const SCALAR_TYPE *s1) {
	result[0]	-=	s1[0];
	result[1]	-=	s1[1];
	result[2]	-=	s1[2];
	result[3]	-=	s1[3];
...
inline	void	divvv4(SCALAR_TYPE *result,const SCALAR_TYPE s2) {
	result[0]	/=  s2;
	result[1]	/=  s2;
	result[2]	/=  s2;
	result[3]	/=  s2;
...
inline	void	fresnel(const SCALAR_TYPE *I,const SCALAR_TYPE *N,SCALAR_TYPE eta,SCALAR_TYPE &Kr,SCALAR_TYPE &Kt,SCALAR_TYPE *R,SCALAR_TYPE *T) {
	...
	const SCALAR_TYPE	g		=	SQRT(maxx(t,0));
