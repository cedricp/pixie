...
int	precomputeNoiseData() {
	...
	#ifdef _WINDOWS
		FILE	*noiseTables	=	fopen(".\\core\\noiseTables.h","w");
	#else
		FILE	*noiseTables	=	fopen("./core/noiseTables.h","w");
	#endif
...
int	precomputeSubdivisionData() {
	...
	out				=	fopen(".\\core\\subdivisionData.h","w");
#else
...
int		precomputeStochasticPrimitivesH() {
	#ifdef _WINDOWS
		FILE	*out	=	fopen(".\\core\\stochasticsPrimitives.h","w");
	#else
		FILE	*out	=	fopen("./core/stochasticPrimitives.h","w");
	#endif
	int		i;
